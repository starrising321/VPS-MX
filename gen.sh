...
[[ ! -e /usr/bin/trans ]] && wget -O /usr/bin/trans https://raw.githubusercontent.com/starrising321/VPS-MX/master/Install/trans &> /dev/null
...
wget https://raw.githubusercontent.com/starrising321/VPS-MX/master/gerador/gerar.sh &>/dev/null
mv gerar.sh /usr/bin/
