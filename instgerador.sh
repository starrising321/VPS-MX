...
SCPT_DIR="/etc/SCRIPT"
SCPresq="aHR0cHM6Ly9yYXcuZ2l0aHVidXNlcmNvbnRlbnQuY29tL3N0YXJyaXNpbmczMjEvVlBTLU1YL21hc3Rlci9nZXJhZG9y"
SUB_DOM='base64 -d'
rm $(pwd)/$0
...
[[ ! -e /usr/bin/trans ]] && wget -O /usr/bin/trans https://raw.githubusercontent.com/starrising321/VPS-MX/Install/trans &> /dev/null
