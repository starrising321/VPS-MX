...
source <(curl -sL https://raw.githubusercontent.com/starrising321/VPS-MX/master/ArchivosUtilitarios/V2RAY/install.sh)
...
unistallv2 () {
source <(curl -sL https://raw.githubusercontent.com/starrising321/VPS-MX/master/ArchivosUtilitarios/V2RAY/install.sh) --remove
}
infocuenta () {
v2ray info
}
