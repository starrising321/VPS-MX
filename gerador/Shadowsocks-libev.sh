...
1)
msg -bar
wget --no-check-certificate -O Instalador-Shadowsocks-libev.sh https://raw.githubusercontent.com/starrising321/VPS-MX/master/ArchivosUtilitarios/Instalador-Shadowsocks-libev.sh > /dev/null 2>&1
