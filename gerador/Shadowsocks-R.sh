...
1)
msg -bar
wget --no-check-certificate -O Instalador-Shadowsocks-R.sh https://raw.githubusercontent.com/starrising321/VPS-MX/master/ArchivosUtilitarios/Instalador-Shadowsocks-R.sh > /dev/null 2>&1
