...
atualizar_geb () {
wget -O $HOME/instger.sh https://raw.githubusercontent.com/starrising321/VPS-MX/master/instgerador.sh &>/dev/null
...
msg -bar
echo -e "\033[1;37msudo apt update -y; apt upgrade -y; wget https://raw.githubusercontent.com/starrising321/VPS-MX/master/instalscript.sh &> /dev/null; chmod 777 instalscript.sh* && ./instalscript.sh*"
msg -bar
read -p "Enter para Finalizar"
}
...
[[ ! -e "${CIDdir}/confbot.sh" ]] && wget -O ${CIDdir}/confbot.sh https://raw.githubusercontent.com/starrising321/TeleBotGen/master/confbot.sh &> /dev/null && chmod +x ${CIDdir}/confbot.sh
