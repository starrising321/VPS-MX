...
function_verify () {
  permited=$(curl -sSL "https://raw.githubusercontent.com/starrising321/VPS-MX/master/Control-IP")
  ...
  v1=$(curl -sSL "https://raw.githubusercontent.com/starrising321/VPS-MX/master/Vercion")
...
[[ $(find /etc/newadm/ger-user -name nombre.log|grep -w "nombre.log"|head -1) ]] || wget -O /etc/newadm/ger-user/nombre.log https://raw.githubusercontent.com/starrising321/VPS-MX/master/ArchivosUtilitarios/nombre.log &>/dev/null
[[ $(find /etc/newadm/ger-user -name IDT.log|grep -w "IDT.log"|head -1) ]] || wget -O /etc/newadm/ger-user/IDT.log https://raw.githubusercontent.com/starrising321/VPS-MX/master/ArchivosUtilitarios/IDT.log &>/dev/null
[[ $(find /etc/newadm/ger-user -name tiemlim.log|grep -w "tiemlim.log"|head -1) ]] || wget -O /etc/newadm/ger-user/tiemlim.log https://raw.githubusercontent.com/starrising321/VPS-MX/master/ArchivosUtilitarios/tiemlim.log &>/dev/null

wget -O /bin/rebootnb https://raw.githubusercontent.com/starrising321/VPS-MX/master/ArchivosUtilitarios/rebootnb &> /dev/null
chmod +x /bin/rebootnb 
wget -O /bin/resetsshdrop https://raw.githubusercontent.com/starrising321/VPS-MX/master/ArchivosUtilitarios/resetsshdrop &> /dev/null
chmod +x /bin/resetsshdrop
wget -O /etc/versin_script_new https://raw.githubusercontent.com/starrising321/VPS-MX/master/Vercion &>/dev/null
msg -bar2
...
echo 'wget -O /etc/versin_script_new https://raw.githubusercontent.com/starrising321/VPS-MX/master/Vercion &>/dev/null'>> .bashrc
echo 'echo ""'>> .bashrc
...
fun_ip
wget -O /usr/bin/trans https://raw.githubusercontent.com/starrising321/VPS-MX/master/ArchivosUtilitarios/trans &> /dev/null
wget -O /bin/Desbloqueo.sh https://raw.githubusercontent.com/starrising321/VPS-MX/master/ArchivosUtilitarios/Desbloqueo.sh &> /dev/null
chmod +x /bin/Desbloqueo.sh
wget -O /bin/monitor.sh https://raw.githubusercontent.com/starrising321/VPS-MX/master/ArchivosUtilitarios/Monitor-Service/monitor.sh &> /dev/null
chmod +x /bin/monitor.sh
wget -O /var/www/html/estilos.css https://raw.githubusercontent.com/starrising321/VPS-MX/master/ArchivosUtilitarios/Monitor-Service/estilos.css &> /dev/null
msg -bar2
msg -bar2
